export class BlockProperties {
    ...
    static readonly PLANT = new BlockProperties({ hasCollision: false, isTransparent: true })
    //#endregion
...
export class Block {
    ...
    static readonly SAPLING             = Block.register(6, 'block.sapling', BlockProperties.PLANT)!
    static readonly BEDROCK             = Block.register(7, 'block.bedrock')!
    static readonly FLOWING_WATER       = Block.register(8, 'block.flowing_water', new BlockProperties({ hasCollision: false, isTransparent: true }))!
    static readonly STATIONARY_WATER    = Block.register(9, 'block.stationary_water', new BlockProperties({ hasCollision: false, isTransparent: true }))!
    static readonly FLOWING_LAVA        = Block.register(10, 'block.flowing_lava', new BlockProperties({ hasCollision: false, isTransparent: true }))!
    static readonly STATIONARY_LAVA     = Block.register(11, 'block.stationary_lava', new BlockProperties({ hasCollision: false, isTransparent: true }))!
    ...
    static readonly LEAVES              = Block.register(18, 'block.leaves', new BlockProperties({ hasCollision: true, isTransparent: true }))!
    static readonly SPONGE              = Block.register(19, 'block.sponge')!
    static readonly GLASS               = Block.register(20, 'block.glass', new BlockProperties({ hasCollision: true, isTransparent: true }))!
    ...
    static readonly LIGHT_GREEN_WOOL    = Block.register(24, 'block.light_green_wool')!
    ...
    static readonly LIGHT_PURPLE_WOOL   = Block.register(31, 'block.light_purple_wool')!
    ...
    static readonly FLOWER              = Block.register(37, 'block.flower', BlockProperties.PLANT)!
    static readonly ROSE                = Block.register(38, 'block.rose', BlockProperties.PLANT)!
    static readonly BROWN_MUSHROOM      = Block.register(39, 'block.brown_mushroom', BlockProperties.PLANT)!
    static readonly RED_MUSHROOM        = Block.register(40, 'block.red_mushroom', BlockProperties.PLANT)!
